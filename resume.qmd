...
<div class="timeline-item">
### Beats by Dre (Data Analyst Internship)  
...
- Identified actionable insights on consumer metrics (e.g., sound quality, design, price sensitivity), contributing to a 15 % improvement in targeted marketing by refining campaign messaging.  
- Analyzed customer sentiment trends, defined satisfaction metrics, and identified key feature preference drivers, providing actionable feedback and decision-support for stakeholders.  
</div>
...
- Successfully raised \$16,419 in sponsorships and prizes by engaging with corporate sponsors and educational institutions such as Demos, AoPS, Interview Cake, Interview Buddy, and Alphastar by crafting tailored sponsorship plans, cold-emailing, and calling companies. These resources significantly increased the event’s impact and reach.  
- Took the initiative to recruit and organize a panel of 8 expert judges from MAANG, Fortune-500 firms (Amazon, Palo Alto Networks, etc.), and top schools (e.g., UC Berkeley), creating volunteer opportunities for industry professionals to participate and evaluate innovative projects.  
...
- **Programming Languages:**  
  - **Advanced:** Python (NumPy, Pandas, Matplotlib, Scikit-learn), SQL, R (Shiny, tidyverse)  
  - **Intermediate:** Java, C++, MATLAB  
- **Tools:** GitHub, Tableau, Jupyter Notebook, MS Office (Word, Excel, PowerPoint, Outlook), LaTeX  
- **Statistical Methods:** Multivariate Data Analysis, Generalized Linear Models (GLMs), ANOVA, A/B Testing  
- **Citizenship:** U.S.-born citizen  
</div>
</div>
